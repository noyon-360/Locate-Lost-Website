...
<head>
    ...
    <title>Locat Lost - Edit Missing Person Report</title>
    ...
    <div class="container mx-auto p-4 sm:p-6">
        <div class="bg-darkSlate p-6 rounded-lg shadow-lg max-w-4xl mx-auto border border-darkBlue">
            <h1 class="text-2xl sm:text-3xl font-bold mb-4 sm:mb-6 text-center text-lightGray">
                <i class="fas fa-user-secret"></i> Edit Missing Person Report
            </h1>
            @if (session('error'))
            ...
            @endif
            <form action="{{ route('update-missing-person', ['id' => $missingPerson->id]) }}" method="POST" enctype="multipart/form-data">
                @csrf
                @method('PUT')
                ...
                <div class="mb-6">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-x-4 gap-y-2">
                        ...
                        <div>
                            <label for="date_of_birth" class="block text-lightGray font-medium mb-1">Date of Birth</label>
                            <input type="date" id="date_of_birth" name="date_of_birth" value="{{ $missingPerson->date_of_birth }}"
                                class="w-full px-2 py-1 border border-lightGray rounded-lg text-lightGray focus:outline-none focus:ring-2 focus:ring-lightGray"
                                required>
                        </div>
                        <div>
                        ...
                        <div>
                            <label for="permanent_address" class="block text-lightGray font-medium mb-1">Permanent Address</label>
                            <textarea id="permanent_address" name="permanent_address"
                                class="w-full px-2 py-1 border border-lightGray rounded-lg text-lightGray focus:outline-none focus:ring-2 focus:ring-lightGray"
                                rows="3" required>{{ $missingPerson->permanent_address }}</textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="mb-6">
                    <h2 class="text-lg sm:text-xl font-semibold mb-4 text-lightGray">
                        <i class="fas fa-info-circle"></i> Missing Info
                    </h2>
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-6">
                        <!-- Missing Date Section -->
                        <div>
                            <label for="missing_date" class="block text-lightGray font-medium mb-1">Missing Date</label>
                            <input type="date" id="missing_date" name="missing_date" value="{{ $missingPerson->missing_date }}"
                                class="w-full px-2 py-1 border border-lightGray rounded-lg text-lightGray focus:outline-none focus:ring-2 focus:ring-lightGray"
                                required>
                        </div>
                        ...
                        <div>
                            <label for="last_seen_location_description" class="block text-lightGray font-medium mb-1">Last Seen Location Description</label>
                            <textarea id="last_seen_location_description" name="last_seen_location_description"
                                class="w-full px-2 py-1 border border-lightGray rounded-lg text-lightGray focus:outline-none focus:ring-2 focus:ring-lightGray"
                                rows="3" required>{{ $missingPerson->last_seen_location_description }}</textarea>
                        </div>
                    </div>
                </div>
                ...
                <div class="mb-6">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-x-4 gap-y-2">
                        <div>
                            <label for="father_name" class="block text-lightGray font-medium mb-1">Father's Name</label>
                            <input type="text" id="father_name" name="father_name" value="{{ $missingPerson->father_name }}"
                                class="w-full px-2 py-1 border border-lightGray rounded-lg text-lightGray focus:outline-none focus:ring-2 focus:ring-lightGray"
                                required>
                        </div>
                        <div>
                            <label for="mother_name" class="block text-lightGray font-medium mb-1">Mother's Name</label>
                            <input type="text" id="mother_name" name="mother_name" value="{{ $missingPerson->mother_name }}"
                                class="w-full px-2 py-1 border border-lightGray rounded-lg text-lightGray focus:outline-none focus:ring-2 focus:ring-lightGray"
                                required>
                        </div>
                    </div>
                ...
                <div class="mb-6">
                    ...
                    <div class="grid grid-cols-1 sm:grid-cols-2 gap-x-4 gap-y-2">
                        <div>
                            <label for="contact_number" class="block text-lightGray font-medium mb-1">Contact Number</label>
                            <input type="tel" id="contact_number" name="contact_number" value="{{ $missingPerson->contact_number }}"
                                class="w-full px-2 py-1 border border-lightGray rounded-lg text-lightGray focus:outline-none focus:ring-2 focus:ring-lightGray"
                                required>
                        </div>
                        <div>
                            <label for="email" class="block text-lightGray font-medium mb-1">Email</label>
                            <input type="email" id="email" name="email" value="{{ $missingPerson->email }}"
                                class="w-full px-2 py-1 border border-lightGray rounded-lg text-lightGray focus:outline-none focus:ring-2 focus:ring-lightGray"
                                required>
                        </div>
                    </div>
                    ...
                    <div class="flex items-center justify-center w-full">
                        <label for="front_image"
                            ...
                            <input id="front_image" name="front_image" type="file" class="hidden" accept="image/*"
                                onchange="showFrontImage(event)" />
                        </label>
                    </div>
                    <div id="front_image_preview" class="mt-2">
                        @if($missingPerson->front_image)
                        <img src="{{ asset('storage/' . $missingPerson->front_image) }}" class="w-20 h-20 object-cover rounded-full">
                        @endif
                    </div>
                </div>
                ...
                <div class="mb-6">
                    ...
                    <div id="additional_pictures_preview" class="mt-2 grid grid-cols-4 gap-2">
                        @foreach(json_decode($missingPerson->additional_pictures) as $picture)
                        <img src="{{ asset('storage/' . $picture) }}" class="w-20 h-20 object-cover rounded">
                        @endforeach
                    </div>
                </div>
